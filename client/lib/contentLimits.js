...
//   - the server (server/src/lib/contentLimits.js), as the real enforcement
//   - here, for maxLength attributes + counters in
//     the admin editor, so the UI stops you before you would hit a server error
const LIMITS = {
  kicker: 80,
  name: 40,
  lede: 320,
